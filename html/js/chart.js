...
document.getElementById('默认').click();
...
function RenderCharts(){
    // addDataPoints();
    ComposeChart("chart_电价", "locational marginal price",
        "hour", "price $/kWh", PopulateDataPoints(lmp), "line");
    ComposeChart("chart_充放电", "charging/discharging power",
        "hour", "kW", PopulateDataPoints(power), "column");
    ComposeChart("chart_电池电量", "energy stored in battery",
